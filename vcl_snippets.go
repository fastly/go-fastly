...
// vclsByName is a sortable list of VCLSnippets.
...
/**
 ...
 GET /service/SU1Z0isxPaozGVKXdv0eY/version/1/snippet
    [
        {
...
/**
 ...
 GET /service/SU1Z0isxPaozGVKXdv0eY/snippet/SU1Z0isxPaozGVKXdv0eY
    {
 ...
 GET /service/SU1Z0isxPaozGVKXdv0eY/version/1/snippet/my_snippet
    {
        "id": "62Yd1WfiCBPENLloXfXmlO",
        "service_id": "SU1Z0isxPaozGVKXdv0eY",
        "version": "1",
...
// Determines whether input has ID property.
func hasID(i *GetVCLSnippetInput) bool {
    return (i.ID != "")
}

// Determines whether input has Name and Version properties.
func hasSnippetNameAndServiceVersion(i *GetVCLSnippetInput) bool {
    return (i.Name != "" && i.Version != 0)
}

// GetVCL gets a VCL snippet with the given parameters.
...
// GetVCL gets a VCL snippet by service name and snippet ID.
...
/service/service_id/version/version/snippet/old_name
...
// DeleteVclSnippetInput is the input parameter to DeleteVCL.
