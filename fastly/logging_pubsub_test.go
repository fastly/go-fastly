...
func TestClient_Pubsubs_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "pubsubs/compute/version", func(c *Client) {
		tv = testVersionCompute(t, c)
	})

	// Create
	var pubsub *Pubsub
	Record(t, "pubsubs/compute/create", func(c *Client) {
		pubsub, err = c.CreatePubsub(context.TODO(), &CreatePubsubInput{
	...
	// Ensure deleted
	defer func() {
		Record(t, "pubsubs/compute/cleanup", func(c *Client) {
			_ = c.DeletePubsub(context.TODO(), &DeletePubsubInput{
				ServiceID:      TestComputeServiceID,
				ServiceVersion: *tv.Number,
				Name:           "test-pubsub",
...
-----END PRIVATE KEY-----` {
	...
	// List
	var pubsubs []*Pubsub
	Record(t, "pubsubs/compute/list", func(c *Client) {
		pubsubs, err = c.ListPubsubs(context.TODO(), &ListPubsubsInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
		})
	...
	// Get
	var npubsub *Pubsub
	Record(t, "pubsubs/compute/get", func(c *Client) {
		npubsub, err = c.GetPubsub(context.TODO(), &GetPubsubInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-pubsub",
	...
	// Update
	var upubsub *Pubsub
	Record(t, "pubsubs/compute/update", func(c *Client) {
		upubsub, err = c.UpdatePubsub(context.TODO(), &UpdatePubsubInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             "test-pubsub",
	...
	// Delete
	Record(t, "pubsubs/compute/delete", func(c *Client) {
		err = c.DeletePubsub(context.TODO(), &DeletePubsubInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-pubsub",
