...
func TestClient_NewRelic(t *testing.T) {
	...
	defer func() {
		Record(t, "newrelic/delete", func(c *Client) {
			_ = c.DeleteNewRelic(context.TODO(), &DeleteNewRelicInput{
				ServiceID:      TestDeliveryServiceID,
				ServiceVersion: *tv.Number,
				Name:           "test-newrelic",
			})
	...
	Record(t, "newrelic/list", func(c *Client) {
		ln, err = c.ListNewRelic(context.TODO(), &ListNewRelicInput{
			ServiceID:      TestDeliveryServiceID,
			ServiceVersion: *tv.Number,
		})
	})
	...
	Record(t, "newrelic/get", func(c *Client) {
		newRelicGetResp, err = c.GetNewRelic(context.TODO(), &GetNewRelicInput{
			ServiceID:      TestDeliveryServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-newrelic",
		})
	...
	Record(t, "newrelic/get2", func(c *Client) {
		newRelicGetResp2, err = c.GetNewRelic(context.TODO(), &GetNewRelicInput{
			ServiceID:      TestDeliveryServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-newrelic-2",
		})
	...
	Record(t, "newrelic/update", func(c *Client) {
		newRelicUpdateResp1, err = c.UpdateNewRelic(context.TODO(), &UpdateNewRelicInput{
			ServiceID:        TestDeliveryServiceID,
			ServiceVersion:   *tv.Number,
			Name:             "test-newrelic",
	...
	Record(t, "newrelic/update2", func(c *Client) {
		_, err = c.UpdateNewRelic(context.TODO(), &UpdateNewRelicInput{
			ServiceID:      TestDeliveryServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-newrelic",
			Region:         ToPointer("zz"),
	...
	// Delete
	Record(t, "newrelic/delete", func(c *Client) {
		err = c.DeleteNewRelic(context.TODO(), &DeleteNewRelicInput{
			ServiceID:      TestDeliveryServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-newrelic",
		})
...
func TestClient_NewRelic_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "newrelic/compute/version", func(c *Client) {
		tv = testVersionCompute(t, c)
	})

	// Create
	var newRelicResp1, newRelicResp2 *NewRelic
	Record(t, "newrelic/compute/create", func(c *Client) {
		newRelicResp1, err = c.CreateNewRelic(context.TODO(), &CreateNewRelicInput{
	...
	Record(t, "newrelic/compute/create2", func(c *Client) {
		newRelicResp2, err = c.CreateNewRelic(context.TODO(), &CreateNewRelicInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           ToPointer("test-newrelic-2"),
	...
	// This case is expected to fail due to an invalid region
	Record(t, "newrelic/compute/create3", func(c *Client) {
		_, err = c.CreateNewRelic(context.TODO(), &CreateNewRelicInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           ToPointer("test-newrelic-3"),
	...
	// Ensure deleted
	defer func() {
		Record(t, "newrelic/compute/delete", func(c *Client) {
			_ = c.DeleteNewRelic(context.TODO(), &DeleteNewRelicInput{
				ServiceID:      TestComputeServiceID,
				ServiceVersion: *tv.Number,
				Name:           "test-newrelic",
	...
	// List
	var ln []*NewRelic
	Record(t, "newrelic/compute/list", func(c *Client) {
		ln, err = c.ListNewRelic(context.TODO(), &ListNewRelicInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
		})
	...
	// Get
	var newRelicGetResp, newRelicGetResp2 *NewRelic
	Record(t, "newrelic/compute/get", func(c *Client) {
		newRelicGetResp, err = c.GetNewRelic(context.TODO(), &GetNewRelicInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-newrelic",
	...
	Record(t, "newrelic/compute/get2", func(c *Client) {
		newRelicGetResp2, err = c.GetNewRelic(context.TODO(), &GetNewRelicInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-newrelic-2",
	...
	// Update
	var newRelicUpdateResp1 *NewRelic
	Record(t, "newrelic/compute/update", func(c *Client) {
		newRelicUpdateResp1, err = c.UpdateNewRelic(context.TODO(), &UpdateNewRelicInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             "test-newrelic",
	...
	// This case is expected to fail due to an invalid region.
	Record(t, "newrelic/compute/update2", func(c *Client) {
		_, err = c.UpdateNewRelic(context.TODO(), &UpdateNewRelicInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-newrelic",
...
func TestClient_ListNewRelic_validation(t *testing.T) {
	...
	_, err = TestClient.ListNewRelic(context.TODO(), &ListNewRelicInput{
		ServiceID: "",
	})
...
func TestClient_CreateNewRelic_validation(t *testing.T) {
	...
	_, err = TestClient.CreateNewRelic(context.TODO(), &CreateNewRelicInput{
		ServiceID: "",
	})
	if !errors.Is(err, ErrMissingServiceID) {
		t.Errorf("bad error: %s", err)
...
func TestClient_GetNewRelic_validation(t *testing.T) {
	...
	_, err = TestClient.GetNewRelic(context.TODO(), &GetNewRelicInput{
		ServiceID:      "foo",
		ServiceVersion: 1,
	})
...
func TestClient_UpdateNewRelic_validation(t *testing.T) {
	...
	_, err = TestClient.UpdateNewRelic(context.TODO(), &UpdateNewRelicInput{
		ServiceID:      "foo",
		ServiceVersion: 1,
	})
	if !errors.Is(err, ErrMissingName) {
...
func TestClient_DeleteNewRelic_validation(t *testing.T) {
	...
	err = TestClient.DeleteNewRelic(context.TODO(), &DeleteNewRelicInput{
		ServiceID:      "foo",
		ServiceVersion: 1,
	})
	if !errors.Is(err, ErrMissingName) {
