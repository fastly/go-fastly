...
// VirtualPatch is the API response structure for the patch virtual
// patch operations.
...
// MetaVirtualPatch is a subset of the VirtualPatch response
// structure.
...
// VirtualPatch is the API response structure for the get and list
// virtial patch operations.
