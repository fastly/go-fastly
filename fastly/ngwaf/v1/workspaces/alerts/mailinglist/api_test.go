...
func Test_WorkspaceAlerts(t *testing.T) {
	...
	if *getTestWorkspaceAlert.Config.Address != *testConfig.Address {
		t.Errorf("unexpected workspace alert config address: got %v, expected %v", *getTestWorkspaceAlert.Config.Address, *testConfig.Address)
	}
	...
	if *updateWorkspaceAlert.Config.Address != *updatedConfig.Address {
		t.Errorf("unexpected updated workspace alert config address: got %v, expected %v", *updateWorkspaceAlert.Config.Address, *updatedConfig.Address)
	}
