...
func TestClient_Bigqueries_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "bigqueries/compute/version", func(c *Client) {
	...
	// Create
	var bq *BigQuery
	Record(t, "bigqueries/compute/create", func(c *Client) {
	...
	// Ensure deleted
	defer func() {
		Record(t, "bigqueries/compute/cleanup", func(c *Client) {
	...
	// List
	var bqs []*BigQuery
	Record(t, "bigqueries/compute/list", func(c *Client) {
	...
	// Get
	var nbq *BigQuery
	Record(t, "bigqueries/compute/get", func(c *Client) {
	...
	// Update
	var ubq *BigQuery
	Record(t, "bigqueries/compute/update", func(c *Client) {
	...
	// Delete
	Record(t, "bigqueries/compute/delete", func(c *Client) {
