...
`)
	...
	Record(t, "https/create", func(c *Client) {
		httpsCreateResp1, err = c.CreateHTTPS(context.TODO(), &CreateHTTPSInput{
			...
			ContentType:       new(JSONMimeType),
			HeaderName:        new("X-Example-Header"),
			HeaderValue:       new("ExampleValue"),
			Method:            new(http.MethodPut),
			JSONFormat:        new("2"),
			Period:            new(5),
			Placement:         new("none"),
...
func TestClient_HTTPS_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "https/compute/version", func(c *Client) {
...
`)
	...
	// Create
	var httpsCreateResp1, httpsCreateResp2, httpsCreateResp3 *HTTPS
	Record(t, "https/compute/create", func(c *Client) {
		httpsCreateResp1, err = c.CreateHTTPS(context.TODO(), &CreateHTTPSInput{
	...
	Record(t, "https/compute/create2", func(c *Client) {
		httpsCreateResp2, err = c.CreateHTTPS(context.TODO(), &CreateHTTPSInput{
			ServiceID:         TestComputeServiceID,
			ServiceVersion:    *tv.Number,
			Name:              new("test-https-2"),
	...
	Record(t, "https/compute/create3", func(c *Client) {
		httpsCreateResp3, err = c.CreateHTTPS(context.TODO(), &CreateHTTPSInput{
			ServiceID:         TestComputeServiceID,
			ServiceVersion:    *tv.Number,
			Name:              new("test-https-3"),
	...
	// This case is expected to fail because both CompressionCodec and
	// GzipLevel are present.
	Record(t, "https/compute/create4", func(c *Client) {
		_, err = c.CreateHTTPS(context.TODO(), &CreateHTTPSInput{
			ServiceID:         TestComputeServiceID,
			ServiceVersion:    *tv.Number,
			Name:              new("test-https-4"),
	...
	// ensure deleted
	defer func() {
		Record(t, "https/compute/cleanup", func(c *Client) {
			_ = c.DeleteHTTPS(context.TODO(), &DeleteHTTPSInput{
				ServiceID:      TestComputeServiceID,
				ServiceVersion: *tv.Number,
				Name:           "test-https",
	...
	// List
	var hs []*HTTPS
	Record(t, "https/compute/list", func(c *Client) {
		hs, err = c.ListHTTPS(context.TODO(), &ListHTTPSInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
		})
	...
	// Get
	var nh *HTTPS
	Record(t, "https/compute/get", func(c *Client) {
		nh, err = c.GetHTTPS(context.TODO(), &GetHTTPSInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-https",
	...
	// Update
	var uh *HTTPS
	Record(t, "https/compute/update", func(c *Client) {
		uh, err = c.UpdateHTTPS(context.TODO(), &UpdateHTTPSInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             "test-https",
	...
	// Delete
	Record(t, "https/compute/delete", func(c *Client) {
		err = c.DeleteHTTPS(context.TODO(), &DeleteHTTPSInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-https",
