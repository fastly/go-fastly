...
func TestClient_GrafanaCloudLogs_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "grafanacloudlogs/compute/version", func(c *Client) {
		tv = testVersionCompute(t, c)
	})

	// Create
	var d *GrafanaCloudLogs
	Record(t, "grafanacloudlogs/compute/create", func(c *Client) {
		d, err = c.CreateGrafanaCloudLogs(context.TODO(), &CreateGrafanaCloudLogsInput{
	...
	// Ensure deleted
	defer func() {
		Record(t, "grafanacloudlogs/compute/delete", func(c *Client) {
			_ = c.DeleteGrafanaCloudLogs(context.TODO(), &DeleteGrafanaCloudLogsInput{
				ServiceID:      TestComputeServiceID,
				ServiceVersion: *tv.Number,
				Name:           "test-grafanacloudlogs",
	...
	// List
	var ld []*GrafanaCloudLogs
	Record(t, "grafanacloudlogs/compute/list", func(c *Client) {
		ld, err = c.ListGrafanaCloudLogs(context.TODO(), &ListGrafanaCloudLogsInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
		})
	...
	// Get
	var nd *GrafanaCloudLogs
	Record(t, "grafanacloudlogs/compute/get", func(c *Client) {
		nd, err = c.GetGrafanaCloudLogs(context.TODO(), &GetGrafanaCloudLogsInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-grafanacloudlogs",
	...
	// Update
	var ud *GrafanaCloudLogs
	Record(t, "grafanacloudlogs/compute/update", func(c *Client) {
		ud, err = c.UpdateGrafanaCloudLogs(context.TODO(), &UpdateGrafanaCloudLogsInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             "test-grafanacloudlogs",
