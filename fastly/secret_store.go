...
type CreateSecretInput struct {
	...
	ClientKey []byte //gosec:disable G117 -- This is the name of the field expected by the the API
	...
	// required format.
	Secret []byte //gosec:disable G117 -- This is the name of the field expected by the the API
	// StoreID of the Secret Store (required).
	StoreID string
}
...
func (c *Client) CreateSecret(ctx context.Context, i *CreateSecretInput) (*Secret, error) {
	...
	err := json.NewEncoder(&body).Encode(struct {
		Name      string `json:"name"`
		Secret    []byte `json:"secret"`               //gosec:disable G117 -- This is the name of the field expected by the the API
		ClientKey []byte `json:"client_key,omitempty"` //gosec:disable G117 -- This is the name of the field expected by the the API
	}{
		Name:      i.Name,
		Secret:    i.Secret,
