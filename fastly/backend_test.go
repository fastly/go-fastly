...
func TestClient_Backends_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "backends/compute/version", func(c *Client) {
		tv = testVersionCompute(t, c)
	})

	// Create
	var b *Backend
	Record(t, "backends/compute/create", func(c *Client) {
	...
	// Ensure deleted
	defer func() {
		Record(t, "backends/compute/cleanup", func(c *Client) {
	...
	if *b.Name != "test-backend-compute" {
	...
	// List
	var bs []*Backend
	Record(t, "backends/compute/list", func(c *Client) {
	...
	// Get
	var nb *Backend
	Record(t, "backends/compute/get", func(c *Client) {
	...
	// Update
	var ub *Backend
	Record(t, "backends/compute/update", func(c *Client) {
	...
	Record(t, "backends/compute/update_ignore_empty_values", func(c *Client) {
		ub, err = c.UpdateBackend(context.TODO(), &UpdateBackendInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-backend-compute",
	...
	Record(t, "backends/compute/update_allow_empty_values", func(c *Client) {
		ub, err = c.UpdateBackend(context.TODO(), &UpdateBackendInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-backend-compute",
	...
	// Delete
	Record(t, "backends/compute/delete", func(c *Client) {
