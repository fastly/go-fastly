...
func TestClient_FTPs_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "ftps/compute/version", func(c *Client) {
		tv = testVersionCompute(t, c)
	})
	// Create
	var ftpCreateResp1, ftpCreateResp2, ftpCreateResp3 *FTP
	Record(t, "ftps/compute/create", func(c *Client) {
		ftpCreateResp1, err = c.CreateFTP(context.TODO(), &CreateFTPInput{
	...
	Record(t, "ftps/compute/create2", func(c *Client) {
		ftpCreateResp2, err = c.CreateFTP(context.TODO(), &CreateFTPInput{
			ServiceID:       TestComputeServiceID,
			ServiceVersion:  *tv.Number,
			Name:            new("test-ftp-2"),
	...
	Record(t, "ftps/compute/create3", func(c *Client) {
		ftpCreateResp3, err = c.CreateFTP(context.TODO(), &CreateFTPInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             new("test-ftp-3"),
	...
	// This case is expected to fail because both CompressionCodec and
	// GzipLevel are present.
	Record(t, "ftps/compute/create4", func(c *Client) {
		_, err = c.CreateFTP(context.TODO(), &CreateFTPInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             new("test-ftp-4"),
	...
	// Ensure deleted
	defer func() {
		Record(t, "ftps/compute/cleanup", func(c *Client) {
			_ = c.DeleteFTP(context.TODO(), &DeleteFTPInput{
				ServiceID:      TestComputeServiceID,
				ServiceVersion: *tv.Number,
				Name:           "test-ftp",
	...
	// Get
	var ftpGetResp *FTP
	Record(t, "ftps/compute/get", func(c *Client) {
		ftpGetResp, err = c.GetFTP(context.TODO(), &GetFTPInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-ftp",
	...
	// Update
	var ftpUpdateResp1, ftpUpdateResp2, ftpUpdateResp3 *FTP
	Record(t, "ftps/compute/update", func(c *Client) {
		ftpUpdateResp1, err = c.UpdateFTP(context.TODO(), &UpdateFTPInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             "test-ftp",
	...
	// Delete
	Record(t, "ftps/compute/delete", func(c *Client) {
		err = c.DeleteFTP(context.TODO(), &DeleteFTPInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-ftp",
