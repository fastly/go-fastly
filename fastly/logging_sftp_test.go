...
func TestClient_SFTPs_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "sftps/compute/version", func(c *Client) {
	...
	// Create
	var sftpCreateResp1, sftpCreateResp2, sftpCreateResp3 *SFTP
	Record(t, "sftps/compute/create", func(c *Client) {
		sftpCreateResp1, err = c.CreateSFTP(context.TODO(), &CreateSFTPInput{
	...
	Record(t, "sftps/compute/create2", func(c *Client) {
		sftpCreateResp2, err = c.CreateSFTP(context.TODO(), &CreateSFTPInput{
			ServiceID:       TestComputeServiceID,
			ServiceVersion:  *tv.Number,
			Name:            new("test-sftp-2"),
	...
	Record(t, "sftps/compute/create3", func(c *Client) {
		sftpCreateResp3, err = c.CreateSFTP(context.TODO(), &CreateSFTPInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             new("test-sftp-3"),
	...
	// This case is expected to fail because both CompressionCodec and
	// GzipLevel are present.
	Record(t, "sftps/compute/create4", func(c *Client) {
		_, err = c.CreateSFTP(context.TODO(), &CreateSFTPInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             new("test-sftp-4"),
	...
	// Ensure deleted
	defer func() {
		Record(t, "sftps/compute/cleanup", func(c *Client) {
			_ = c.DeleteSFTP(context.TODO(), &DeleteSFTPInput{
				ServiceID:      TestComputeServiceID,
				ServiceVersion: *tv.Number,
				Name:           "test-sftp",
	...
	// List
	var sftps []*SFTP
	Record(t, "sftps/compute/list", func(c *Client) {
		sftps, err = c.ListSFTPs(context.TODO(), &ListSFTPsInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
		})
	...
	// Get
	var sftpGetResp *SFTP
	Record(t, "sftps/compute/get", func(c *Client) {
		sftpGetResp, err = c.GetSFTP(context.TODO(), &GetSFTPInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-sftp",
	...
	// Update
	var sftpUpdateResp1, sftpUpdateResp2, sftpUpdateResp3 *SFTP
	Record(t, "sftps/compute/update", func(c *Client) {
		sftpUpdateResp1, err = c.UpdateSFTP(context.TODO(), &UpdateSFTPInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             "test-sftp",
	...
	// Delete
	Record(t, "sftps/compute/delete", func(c *Client) {
		err = c.DeleteSFTP(context.TODO(), &DeleteSFTPInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-sftp",
