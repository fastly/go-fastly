...
func TestClient_GCSs_Compute(t *testing.T) {
	t.Parallel()

	var err error
	var tv *Version
	Record(t, "gcses/compute/version", func(c *Client) {
		tv = testVersionCompute(t, c)
	})

	// Create
	var gcsCreateResp1, gcsCreateResp2, gcsCreateResp3 *GCS
	Record(t, "gcses/compute/create", func(c *Client) {
		gcsCreateResp1, err = c.CreateGCS(context.TODO(), &CreateGCSInput{
	...
	Record(t, "gcses/compute/create2", func(c *Client) {
		gcsCreateResp2, err = c.CreateGCS(context.TODO(), &CreateGCSInput{
			ServiceID:       TestComputeServiceID,
			ServiceVersion:  *tv.Number,
			Name:            new("test-gcs-2"),
	...
	Record(t, "gcses/compute/create3", func(c *Client) {
		gcsCreateResp3, err = c.CreateGCS(context.TODO(), &CreateGCSInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             new("test-gcs-3"),
	...
	// This case is expected to fail because both CompressionCodec and
	// GzipLevel are present.
	Record(t, "gcses/compute/create4", func(c *Client) {
		_, err = c.CreateGCS(context.TODO(), &CreateGCSInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             new("test-gcs-4"),
	...
	// Ensure deleted
	defer func() {
		Record(t, "gcses/compute/cleanup", func(c *Client) {
			_ = c.DeleteGCS(context.TODO(), &DeleteGCSInput{
				ServiceID:      TestComputeServiceID,
				ServiceVersion: *tv.Number,
				Name:           "test-gcs",
	...
	// List
	var gcses []*GCS
	Record(t, "gcses/compute/list", func(c *Client) {
		gcses, err = c.ListGCSs(context.TODO(), &ListGCSsInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
		})
	...
	// Get
	var gcsGetResp *GCS
	Record(t, "gcses/compute/get", func(c *Client) {
		gcsGetResp, err = c.GetGCS(context.TODO(), &GetGCSInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "test-gcs",
	...
	// Update
	var gcsUpdateResp1, gcsUpdateResp2, gcsUpdateResp3 *GCS
	Record(t, "gcses/compute/update", func(c *Client) {
		gcsUpdateResp1, err = c.UpdateGCS(context.TODO(), &UpdateGCSInput{
			ServiceID:        TestComputeServiceID,
			ServiceVersion:   *tv.Number,
			Name:             "test-gcs",
	...
	// Delete
	Record(t, "gcses/compute/delete", func(c *Client) {
		err = c.DeleteGCS(context.TODO(), &DeleteGCSInput{
			ServiceID:      TestComputeServiceID,
			ServiceVersion: *tv.Number,
			Name:           "new-test-gcs",
