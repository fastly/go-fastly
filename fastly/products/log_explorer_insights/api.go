...
// Get gets the status of the Log Explorer & Insights product on the service.
...
// Enable enables the Log Explorer & Insights product on the service.
...
// Disable disables the Log Explorer & Insights product on the service.
